...
description": "Creates a ChemDraw (.cdxml) file. You can pass a SMILES string OR a common name like 'caffeine'. If you pass a name, the tool will automatically look up the structure for you.
